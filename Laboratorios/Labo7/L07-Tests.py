import numpy as np
from labo7 import transiciones_al_azar_continuas, transiciones_al_azar_uniformes, nucleo, crea_rala, multiplica_rala_vector
...
def test_dos():# caso borde: lista vacia. Esto es una matriz de 0s
    listado = [[],[],[]]
    A_rala_dict, dims = crea_rala(listado,10,10)
